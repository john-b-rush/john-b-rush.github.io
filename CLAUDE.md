...
- Posts use front matter `title` and `description` but no `layout` key (defaults handle it)
- Asset paths from posts use `../assets/` (relative)
- The `_generate-real-data.py` script is intentionally uncommitted (backup on Desktop)
